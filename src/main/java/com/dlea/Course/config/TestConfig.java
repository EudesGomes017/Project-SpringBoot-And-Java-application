package com.dlea.Course.config;
...
import com.dlea.Course.repositories.CategoryRepository;
import com.dlea.Course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//associação dos produtos com as categorias muitos para muitos, associação de objetos
